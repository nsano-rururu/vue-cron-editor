...
const arrayOfDays = fc.set(fc.oneof(fc.constant("MON"), fc.constant("TUE"), fc.constant("WED"), fc.constant("THU"), fc.constant("FRI"), fc.constant("SAT"), fc.constant("SUN")), { minLength: 1, maxLength: 7 });
...
export const state = fc.oneof(minutesStateArbitrary, hourlyStateArbitrary, dailyStateArbitrary, weeklyStateArbitrary, monthlyStateArbitrary);
//# sourceMappingURL=aribitraries.js.map